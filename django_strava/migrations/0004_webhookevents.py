        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_type",
                    models.IntegerField(
                        choices=[(1, "Activity"), (2, "Athlete")],
                        help_text='Always either "activity" or "athlete."',
                    ),
                ),
                (
                    "aspect_type",
                    models.IntegerField(
                        ...
                        help_text='Always "create," "update," or "delete."',
                    ),
                ),
                (
                    "object_id",
                ...
                (
                    "event_time",
                    models.BigIntegerField(
                        help_text="The time that the event occurred."
                    ),
                ),
            ],
        ),
